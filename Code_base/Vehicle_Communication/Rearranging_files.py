...
input_base_dir = "/dataset/Communication/Required"  # Replace with actual input directory
output_base_dir = "/dataset/Communication/output_directory"  # Replace with actual output directory
