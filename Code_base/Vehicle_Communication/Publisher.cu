...
const std::string BASE_DIR = "/dataset/Communication/output_directory";   // Directory for writing matched results
...
frame_point_cloud.reset(new pcl::PointCloud<pcl::PointXYZ>);
