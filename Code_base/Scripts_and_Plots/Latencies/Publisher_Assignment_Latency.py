...
input_dir = "/dataset/Communication/Producer_Assignment_Latencies"  # Replace with actual directory path

# Output file
output_file = "/workspace/Results/Latency_Results/Publisher_Assignment_Latencies.txt"
