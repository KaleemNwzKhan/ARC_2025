...
text_filename << "Vehicles_Cells/Vehicle_" << static_cast<int>(Vehicle_number) 
              << "/" << new_filename << ".txt";
...
//***************************************************Producers Assignment******************************************************************
    ...
    //     std::string latencies_file = "Producer_Assignment_Latencies/Vehicle_" + std::to_string(v)+ ".txt";
