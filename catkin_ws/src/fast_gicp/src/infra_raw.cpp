...
int main(int argc, char **argv) {
  ...
  log_file << "frame_number" << "," << "Latency_pass"<<"," << "Latency_load_pcd" << "," << "Latency_diff" "," << "Latency_extract" << "," << "Latency_compression "<< "," << "Latency_total" <<std::endl;
...
//     auto duration_pass = (t2 - t1).toSec();
//     // auto duration_compress = (t3 - t2).toSec();

//     log_file << pc_counter << "," << duration_pass* 1000 << std::endl;
//     //log_file << pc_counter << "," << duration_pass* 1000 << ","<<duration_load*1000 <<","<< duration_diff*1000 <<","<<duration_extract*1000 <<"," << duration_compress*1000<<","<< duration_total*1000<<std::endl;
...
void Point_Cloud_Callback(boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ>> msg) {
  ...
  // // Publish diff point cloud
    ...
    log_file << pc_counter << "," << duration_pass << "," << duration_compress<<std::endl;
    //log_file << pc_counter << "," << duration_pass* 1000 << ","<<duration_load*1000 <<","<< duration_diff*1000 <<","<<duration_extract*1000 <<"," << duration_compress*1000<<","<< duration_total*1000<<std::endl;
    //std::cout << "Latency_diff :" << duration_diff * 1000 << ": msec" << std::endl;
    //std::cout << "Latency_compress :" << duration_compress * 1000 << ": msec" << std::endl;
    //std::cout << pc_counter <<std::endl;
