...
// global objects
std::ofstream log_file, ndt_poses;
...
int main(int argc, char **argv) {
  ...
  // log_file.open("/workspace/log_time_vehicle.csv",std::ios::app );
  // ndt_poses.open("/workspace/ndt.txt", std::ios::app );
  log_file.open("/workspace/log_time_vehicle.csv" );
  ndt_poses.open("/workspace/ndt.txt" );

  //log_file << "frame_number" << "," << "fitness" << "," << "latency_downsample" << "," << "latency_ndt" << ","<< "latency_total"<<std::endl;
...
void Point_Cloud_Callback(boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ>> msg) {
  ...
  log_file << duration_downsample << "," << duration_ndt << "," << duration_total << std::endl;


  //std::cout << "Latency_downsample :" << duration_downsample * 1000 << ": msec" << std::endl;
  //std::cout << "Latency_ndt :" << duration_ndt * 1000 << ": msec" << std::endl;
  //std::cout << "latency_total :" << duration_total * 1000 << ": msec" << std::endl;
...
pcl::PointCloud<pcl::PointXYZ>::Ptr NDT_Align(fast_gicp::NDTCuda<pcl::PointXYZ, pcl::PointXYZ>&  registration, const pcl::PointCloud<pcl::PointXYZ>::Ptr &source_cloud) {
    ...
    log_file << registration.getFitnessScore() << "," ; 
