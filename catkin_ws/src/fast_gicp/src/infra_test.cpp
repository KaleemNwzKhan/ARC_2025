...
compressed_diff.data = "hello world hello world hello world hello world hello world hello world hello world hello world hello world hello world hello world hello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhello worldhellohello worldhello worldhello worldhello";
...
void Point_Cloud_Callback(boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ>> msg) {
    ...
    Publish_String(&diff_compress_pub, 1, compressed_diff);
        ...
        // auto duration_diff = (t2 - t1).toSec();
