...
// #pragma omp parallel for reduction(+:latency_avg) 
for (const std::string &filename : files_in_directory_V)
  {
    ...
    // std::cout<<"Vehicle file: "<<files_in_directory_V[pcd_count]<<std::endl;
  ...
  //  std::cout<<"Infra file: "<<files_in_directory_I[pcd_count]<<std::endl;
