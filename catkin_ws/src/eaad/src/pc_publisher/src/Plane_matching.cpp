...
{
std::ofstream myfile;
  myfile.open ("src/eaad/src/pc_publisher/src/Plane_2.txt");
  pcl::PointCloud<pcl::PointXYZ>::Ptr cloud(new pcl::PointCloud<pcl::PointXYZ>);
    if (pcl::io::loadPCDFile<pcl::PointXYZ> ("src/eaad/src/pc_publisher/src/Cropped_Map.pcd", *cloud) == -1)
  {
...
pcl::io::savePCDFileASCII ("src/eaad/src/pc_publisher/src/Plane_2.pcd", *target_cloud);
  return (0);
}
